...
// TODO: change this test to use sha256 (tests are still valid only the
//  generated hash differs, of course)
...
// selected set of secret keys, messages, and nonces that have been verified
...
// // of secret keys, messages, and nonces that have been verified independently
...
// // signatures for a selected set of secret keys, messages, and nonces that have
...
// 		gotSig, recoveryCode, success := sign(&secKey.Key, nonce, hash)
// 		if !success {
...
// expected for randomly-generated secret keys and messages.  It also ensures
...
// // secret keys, messages, and nonces that have been verified independently with
...
//
// 			// Sign the hash of the message with the given secret key and
...
// ECDSA signing and recovery work as expected for randomly-generated secret
