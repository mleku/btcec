...
func TestFieldNormalize(t *testing.T) {
	tests := []struct {
		...
		name: "2^64 - 1",
		raw: [10]uint32{0xffffffff, 0xffffffc0, 0xfc0, 0, 0, 0, 0, 0, 0,
			0},
		normalized: [10]uint32{0x03ffffff, 0x03ffffff, 0xfff, 0, 0, 0, 0, 0, 0,
			0},
	}, {
		name: "2^64",
		raw: [10]uint32{0x04000000, 0x03ffffff, 0x0fff, 0, 0, 0, 0, 0, 0,
			0},
		normalized: [10]uint32{0x00000000, 0x00000000, 0x1000, 0, 0, 0, 0, 0, 0,
			0},
	}, {
		name: "2^64 + 1",
		raw: [10]uint32{0x04000001, 0x03ffffff, 0x0fff, 0, 0, 0, 0, 0, 0,
			0},
		normalized: [10]uint32{0x00000001, 0x00000000, 0x1000, 0, 0, 0, 0, 0, 0,
			0},
	}, {
		name: "2^96 - 1",
		raw: [10]uint32{0xffffffff, 0xffffffc0, 0xffffffc0, 0x3ffc0, 0,
			0, 0, 0, 0, 0},
		normalized: [10]uint32{0x03ffffff, 0x03ffffff, 0x03ffffff, 0x3ffff, 0,
			0, 0, 0, 0, 0},
	}, {
		name: "2^96",
		raw: [10]uint32{0x04000000, 0x03ffffff, 0x03ffffff, 0x3ffff, 0,
			0, 0, 0, 0, 0},
		normalized: [10]uint32{0x00000000, 0x00000000, 0x00000000, 0x40000, 0,
			0, 0, 0, 0, 0},
	}, {
		name: "2^128 - 1",
		raw: [10]uint32{0xffffffff, 0xffffffc0, 0xffffffc0, 0xffffffc0,
			0xffffc0, 0, 0, 0, 0, 0},
		normalized: [10]uint32{0x03ffffff, 0x03ffffff, 0x03ffffff, 0x03ffffff,
			0xffffff, 0, 0, 0, 0, 0},
	}, {
		name: "2^128",
		raw: [10]uint32{0x04000000, 0x03ffffff, 0x03ffffff, 0x03ffffff,
			0x0ffffff, 0, 0, 0, 0, 0},
		normalized: [10]uint32{0x00000000, 0x00000000, 0x00000000, 0x00000000,
			0x1000000, 0, 0, 0, 0, 0},
	}, {
		name: "2^256 - 4294968273 (secp256k1 prime)",
		raw: [10]uint32{0xfffffc2f, 0xffffff80, 0xffffffc0, 0xffffffc0,
		...
		raw: [10]uint32{0xfffffc30, 0xffffff86, 0xffffffc0, 0xffffffc0,
			0xffffffc0, 0xffffffc0, 0xffffffc0,
			0xffffffc0, 0xffffffc0, 0x3fffc0},
		normalized: [10]uint32{0x00000001, 0x00000006, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x000000},
	}, {
		...
		raw: [10]uint32{0xfffffc2a, 0xffffff87, 0xffffffc0, 0xffffffc0,
			0xffffffc0, 0xffffffc0, 0xffffffc0,
			0xffffffc0, 0xffffffc0, 0x3fffc0},
		normalized: [10]uint32{0x03fffffb, 0x00000006, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x000000},
	}, {
		name: "2^256 - 1",
		raw: [10]uint32{0xffffffff, 0xffffffc0, 0xffffffc0, 0xffffffc0,
			0xffffffc0, 0xffffffc0, 0xffffffc0,
			0xffffffc0, 0xffffffc0, 0x3fffc0},
		normalized: [10]uint32{0x000003d0, 0x00000040, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x000000},
	}, {
		...
		name: "2^256 - 4294968273 (secp256k1 prime)",
		raw: [10]uint32{0x03fffc2f, 0x03ffffbf, 0x03ffffff, 0x03ffffff,
		...
		raw: [10]uint32{0x03fffc30, 0x03ffffbf, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x003fffff},
		normalized: [10]uint32{0x00000001, 0x00000000, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x00000000},
	}, {
		// Value larger than P that reduces to a value which is still larger
		...
		raw: [10]uint32{0x03fffc2f, 0x03ffffc0, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x003fffff},
		normalized: [10]uint32{0x00000000, 0x00000001, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x00000000},
	}, {
		// Value larger than P that reduces to a value which is still larger
		...
		raw: [10]uint32{0x03ffffff, 0x03fffeff, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x0013fffff},
		normalized: [10]uint32{0x00001314, 0x00000040, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x00000000,
		...
		raw: [10]uint32{0x03fffc30, 0x03ffffc0, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x07ffffff, 0x003fffff},
		normalized: [10]uint32{0x00000001, 0x00000001, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x00000000,
			0x00000000, 0x00000000, 0x00000001},
	}, {
		// ---------------------------------------------------------------------
		...
		raw: [10]uint32{0x03fff85e, 0x03ffffbf, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03fffffe, 0x003ffffe},
		normalized: [10]uint32{0x03fff85e, 0x03ffffbf, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03fffffe, 0x003ffffe},
	}, {
		name: "Value < 2^256 final reduction combination 1 via 2nd word",
		raw: [10]uint32{0x03fff85e, 0x03ffffc0, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03fffffe, 0x003ffffe},
		normalized: [10]uint32{0x03fff85e, 0x03ffffc0, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03fffffe, 0x003ffffe},
	}, {
		...
		raw: [10]uint32{0x03fffc2f, 0x03ffffbf, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03fffffe, 0x003ffffe},
		normalized: [10]uint32{0x03fffc2f, 0x03ffffbf, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03ffffff, 0x03ffffff,
			0x03ffffff, 0x03fffffe, 0x003ffffe},
	}, {
