...
import (
	...
	bech322 "github.com/mleku/btcec/v2/bech32"
	"github.com/mleku/btcec/v2/chaincfg"
)
...
func decodeSegWitAddress(address B) (byte, []byte, error) {
	...
	regrouped, err := bech322.ConvertBits(data[1:], 5, 8, false)
	if err != nil {
		return 0, nil, err
	}
	...
	if version == 0 && bech32version != bech322.Version0 {
	...
	if version == 1 && bech32version != bech322.VersionM {
